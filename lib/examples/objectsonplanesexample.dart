  ...
  Future<void> onPlaneOrPointTapped(List<ARHitTestResult> hitTestResults) async {
    ...
    if (singleHitTestResult != null) {
      ...
      if (didAddAnchor!) {
        ...
        // Add note to anchor
        var newNode = ARNode(type: NodeType.webGLB, uri: "https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/AnimatedMorphSphere/glTF-Binary/AnimatedMorphSphere.glb", scale: Vector3(0.2, 0.2, 0.2), position: Vector3(0.0, 0.0, 0.0), rotation: Vector4(1.0, 0.0, 0.0, 0.0));
