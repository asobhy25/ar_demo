  ...
  Future<void> onPlaneOrPointTapped(List<ARHitTestResult> hitTestResults) async {
    ...
    if (singleHitTestResult != null) {
      ...
      if (didAddAnchor!) {
        ...
        // Add note to anchor
        var newNode = ARNode(type: NodeType.webGLB, uri: "https://github.com/KhronosGroup/glTF-Sample-Models/raw/master/2.0/Duck/glTF-Binary/Duck.glb", scale: Vector3(0.2, 0.2, 0.2), position: Vector3(0.0, 0.0, 0.0), rotation: Vector4(1.0, 0.0, 0.0, 0.0));
